...
Bolt is a general purpose **self-hostable** Discord bot built with Pycord! (very heavily WIP)

Join the support/testing server: https://discord.gg/hF6mgCE3gT

Invite Bolt to your server: https://sparkhere-sys.github.io/bolt

Read the full documentation: https://bolt-bot.readthedocs.io/en/latest

## Self-hosting

Want to run Bolt yourself, or add some spice to your server?
